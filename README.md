...
## Contributing
    ...
    Fork and create a feature branch (e.g., feat/...).

    Follow PEP8, add type hints and Google-style docstrings.

    Add/update tests and ensure they pass locally (and in CI).

    Open a Pull Request with a clear description (what/why/how to test).
...
PayPal.me → https://www.paypal.com/paypalme/enricomarogna/5
## Credits

Author: Enrico Marogna – https://enricomarogna.com
